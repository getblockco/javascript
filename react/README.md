...
## Basic Rules
  - Functional components should **ALWAYS** be used over Class Components unless absolutely necessary. 
    - Use of hooks should be standard.
...
## Class vs Stateless Components
  ...
  **Always** prefer normal functions (not arrow functions) over classes and use hooks to create stateless functional components:
  ...
  If you **absolutely** must create a class component, prefer `class extends React.Component` over `React.createClass`.
...
## Hooks
  ...
  > Why? Easier to decouple logic from UI, making both more reusable.
  ...
  ```
   ...
   For the **useState** hook, always use camelCase for the variable name and then for naming the function, use the set + variable name.
